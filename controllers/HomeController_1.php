...
class HomeController extends \yii\web\Controller {
    ...
    public function actionIndex() {
        ...
        $all_years = Audios::find()->select('year(date) as date')->distinct()->orderBy(['date' => 'ASC'])->all();
        $all_years_articles = \app\models\Articles::find()->select('year(date) as date')->distinct()->orderBy(['date' => 'ASC'])->all();
